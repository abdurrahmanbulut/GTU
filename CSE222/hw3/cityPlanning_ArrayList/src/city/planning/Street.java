...
public class Street {
    ...
    ArrayList<Structure> leftSideBuildings;
    ArrayList<Structure> rightSideBuildings;

    // getters for buildings array.
    public ArrayList<Structure> getLeftSideBuildings() {
        return leftSideBuildings;
    }
    public ArrayList<Structure> getRightSideBuildings() {
        return rightSideBuildings;
    }

    public Street() {
        leftSideBuildings = new ArrayList<>();
        rightSideBuildings = new ArrayList<>();
    }
