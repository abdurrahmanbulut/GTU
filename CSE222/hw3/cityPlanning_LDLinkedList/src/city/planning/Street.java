...
public class Street {
    ...
    LDLinkedList<Structure> leftSideBuildings;
    LDLinkedList<Structure> rightSideBuildings;
    ...
    public Street() {
        leftSideBuildings = new LDLinkedList<>();
        rightSideBuildings = new LDLinkedList<>();
    }
    ...
    // this func gets an object ref. and a side(left or right). It uses delete func of LDLinkedList container class.
